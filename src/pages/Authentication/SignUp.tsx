            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <select className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                      <option value="">Select your Department</option>
                      <option value="john.doe">
                        Office of the Building Official
                      </option>
                      <option value="jane.doe">BFP</option>
                      <option value="other">Zoning Division</option>
                    </select>
                    <span className="absolute right-4 top-4">
                      {/* <svg
                        className="fill-current"
